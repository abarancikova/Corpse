  ...
  render() {
    return (
      <div className='all_encomp'>
        ...
        <a href="https://docs.google.com/document/d/1fphIVNir-0WOTRuiAURv1HM1YOOpGDN7Ewf4wkR5LBs/edit" target="_blank" class="custom-link"> <div >Click here if you encounter any issues</div></a>
        </div>
